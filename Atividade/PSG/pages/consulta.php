...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="../css/tcursos.css" />
</head>

<body>
  <main>
    <!-- vai substituir a div corpo -->
    ...
    <div id="divMenu">
      ...
      <div id="divUsuarioLogado">
        ...
        if (isset($_SESSION['nome_usu_sessao'])) {
          ...
          echo "<a href='consulta.php?logout'>Logout</a> ";
    ...
    <section id="sectionMeio">
      ...
      <article id="articleInformacoesSup">
        <h1 class="h2">
          Senac-RS oferece mais de 2.000 vagas gratuitas para cursos técnicos
          presenciais. Inscrições até 18/07.
        </h1>
        <p class="pText">
        ...
        <h3 id="h3">Confira os cursos em destaque!</h3>
        <p class="pText">
          <a href="#tecnico">Cursos Técnicos</a>-
          <a href="#trilha">Trilha RS TI</a>-
          <a href="#livre">Cursos livres</a>
        </p>
        <h2 id="h3">Conheça o regulamento</h2>
        <p class="pText">
          <a href="../pdf/regulamento.pdf" target="blank"> Clique aqui</a>
        </p>
        <p class="pText">
          <a
            href="https://apsweb.senacrs.com.br/modulos/vestibular/"
            target="blank">
            Inscreva-se
          </a>
        </p>
      ...
      <article class="articleCursos">
        <div class="divTextCursos">
          <h1 id="tecnico" class="h2">
            Confira os cursos técnicos gratuitos em destaque!
          </h1>
        </div>
      ...
      <article class="articleCursos">
        <div class="divTextCursos">
          <h1 class="h2">Confira os demais cursos gratuitos disponíveis!</h1>
        </div>
        <div class="divCardsCursos">
          <div class="divCursos">
            <p class="pText">
              <img
                class="imgDemaisCursos"
                src="../img/tec_administracao.jpg"
                alt="Técnico em administração"
                title="Técnico em administração" />
              <br />
              Categoria: Técnico
        ...
        <div class="divCardsCursos">
          <div class="divCursos">
            <p class="pText">
              ...
              Escola: Senac Canoas
              <br />
              Inscrições: Inscrições: 15/07/2024 a 29/07/2024.
              <br />
              Modalidade: Presencial.
              <br />
              Vagas: 25
      ...
      <article id="articleTabela">
        <div id="divTabela">
          <h2 class="h2">Confira os demais cursos gratuitos disponíveis!</h2>

          <table>
            <thead>
              <tr>
                <td class="tdHeadeFooter">
                  <h3 class="h3HeadeFooter">Escola</h3>
                </td>
                <td class="tdHeadeFooter">
                  <h3 class="h3HeadeFooter">Informações</h3>
                </td>
                <td class="tdHeadeFooter">
                  <h3 class="h3HeadeFooter">Curso</h3>
                </td>
              </tr>
            </thead>
            <tbody>
              <tr>
                <td class="tdCont1">
                  <h3 class="h3Tbody">Senac Camaquã</h3>
                </td>
                <td class="tdCont1">
                  <h3 class="h3Tbody">
                    Inscrições: 06/05/2024 a 21/07/2024
              ...
              <tr>
                <td class="tdCont2">
                  <h3 class="h3Tbody">Senac Rio Grande</h3>
                </td>
                <td class="tdCont2">
                  <h3 class="h3Tbody">
                    Inscrições: 17/06/2024 a 22/06/2024
              ...
              <tr>
                <td class="tdCont1">
                  <h3 class="h3Tbody">Senac Taquara</h3>
                </td>
                <td class="tdCont1">
                  <h3 class="h3Tbody">
                    Inscrições: 21/06/2024 a 17/07/2024
              ...
              <tr>
                <td class="tdCont2">
                  <h3 class="h3Tbody">Senac Santa Rosa</h3>
                </td>
                <td class="tdCont2">
                  <h3 class="h3Tbody">
                    Inscrições: 06/06/2024 a 05/07/2024
              ...
              <tr>
                <td class="tdCont1">
                  <h3 class="h3Tbody">Senac Lajeado</h3>
                </td>
                <td class="tdCont1">
                  <h3 class="h3Tbody">
                    Inscrições: 22/04/2024 a 21/06/2024
              ...
              <tr>
                <td class="tdCont2">
                  <h3 class="h3Tbody">Senac Montenegro</h3>
                </td>
                <td class="tdCont2">
                  <h3 class="h3Tbody">
                    Inscrições: 03/07/2024 a 11/09/2024
              ...
              <tr>
                <td class="tdCont1">
                  <h3 class="h3Tbody">Senac Canoas</h3>
                </td>
                <td class="tdCont1">
                  <h3 class="h3Tbody">
              ...
              <tr>
                <td class="tdCont1">
                  <h3 class="h3Tbody">Senac São Leopoldo</h3>
                </td>
                <td class="tdCont1">
                  <h3 class="h3Tbody">
                    Inscrições: 04/07/2024 a 31/07/2024
            ...
            <tfoot>
              <tr>
                <td class="tdHeadeFooter" colspan="3">
                  <h3 class="h3HeadeFooter">Mudando a vida!</h3>
                </td>
              </tr>
            </tfoot>
          </table>
