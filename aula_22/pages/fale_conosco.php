	...
	<section id="sectionForms">
		<article id="articleForms">
			...
			<form action="#" method="post">
				<fieldset><!--inicio fieldsetPrincipal-->
					...
					<fieldset class="bloco">
						<div class="dados">
							...
							required 
							title="O número deve conter 11 dígitos, 
							começando pelo DDD" 
							pattern="[0-9]{11}"/>
						</div><!--fim div dados-->
					</fieldset><!--fim fieldset bloco-->
					...
					<fieldset class="bloco">
						<div class="dados">
							...
							required 
							title="A senha deve conter no mínimo 
				...
				</fieldset><!--fim fieldsetPrincipal-->
			</form>
		</article><!--fim articleForms -->
	</section><!--fim sectionForms -->
